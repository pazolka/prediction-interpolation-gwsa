...
Raw target dataset (original weekly monitored groundwater level time-series dataset) is unpublished and can be obtained from the [Bangladesh Water Development Board](http://www.hydrology.bwdb.gov.bd/index.php) though an online data request and payment. Processed monthly time-series dataset used in this work was compiled by [3].
...
- `2_2_data_imputation_missForest.R` temporal gap filling based on _missForest_ [6].
...
[3] Mohammad Shamsudduha et al. (2022), The Bengal Water Machine: Quantified freshwater capture in Bangladesh. Science 377,1315-1319, doi:10.1126/science.abm4730.
...
[6] Stekhoven DJ, Bühlmann P (2012), MissForest: nonparametric missing value imputation for mixed-type data. Bioinformatics, 28(1), 112–118. doi:10.1093/bioinformatics/btr597.
